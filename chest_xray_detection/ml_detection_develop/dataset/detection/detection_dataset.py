...
from chest_xray_detection.ml_detection_develop.configs.settings import LABEL_MAPPING_DICT
...
class DetectionDataset(Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            annotation_filepath (Union[str, Path]): Path to the CSV file containing annotations.
            transforms (Optional[Compose]): Transformations to be applied to the images. Defaults to None.
            merge_classes (bool): Whether to merge all classes into one. Defaults to False.
        """
