...
from chest_xray_detection.ml_detection_develop.configs.settings import DATA_PATH, LABEL_MAPPING_DICT
...
def get_train_val_dataloaders(
    ...
    Args:
        ...
        merge_classes (bool, optional): Whether to merge classes. Defaults to False.
...
def get_single_dataloader(
    ...
    Args:
        ...
        batch_size (int): Batch size for DataLoader.
        num_workers (int, optional): Number of subprocesses to use for data loading. Defaults to 4.
        merge_classes (bool, optional): Whether to merge classes. Defaults to True.
